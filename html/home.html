        ...
        <div id="wrapper">
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav hidden-xs">
                                <li><a href="index.html#" class="waves-effect">Files</a></li>
                                <li class="dropdown">
                                    <a href="index.html#" class="dropdown-toggle waves-effect" data-toggle="dropdown"
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown hidden-xs">
                                    <a href="index.html#" data-target="#" class="dropdown-toggle waves-effect waves-light"
                                ...
                                <li class="hidden-xs">
                                    <a href="index.html#" class="right-bar-toggle waves-effect waves-light"><i
            ...
            <div class="left side-menu">
                ...
                <div class="user-detail">
                    <div class="dropup">
                        <a href="index.html" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">
                ...
                <div class="content">
                    <div class="container">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb pull-right">
                                        <li><a href="index.html#">Minton</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="widget-simple-chart text-right card-box">
                                    <div class="circliful-chart" data-dimension="90" data-text="75%" data-width="5" data-fontsize="14" data-percent="75" data-fgcolor="#6a76fc" data-bgcolor="#ebeff2"></div>
